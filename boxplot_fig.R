...
###############################################################################
#Figure 13: boxplot choice of the themes
###############################################################################
...
axis(1, at=c(1,2,3),labels=c("Academic","Public","Private"),
...
tempmean<-aggregate(tmp$q_nb_participant_choice,
                    ...
                    mean)[,2]
points(c(1,2,3),tempmean,pch=25,col="red",bg="red",cex=1)
...
#####Boxplot - Nouvelle Figure  Partie 3.3.3 
